...
public final class StockServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.quang.stock.StockPriceRequest,
      com.quang.stock.StockPriceResponse> getGetStockPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetStockPrice",
      requestType = com.quang.stock.StockPriceRequest.class,
      responseType = com.quang.stock.StockPriceResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.quang.stock.StockPriceRequest,
      com.quang.stock.StockPriceResponse> getGetStockPriceMethod() {
    io.grpc.MethodDescriptor<com.quang.stock.StockPriceRequest, com.quang.stock.StockPriceResponse> getGetStockPriceMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetStockPriceMethod = StockServiceGrpc.getGetStockPriceMethod) == null) {
          StockServiceGrpc.getGetStockPriceMethod = getGetStockPriceMethod =
              io.grpc.MethodDescriptor.<com.quang.stock.StockPriceRequest, com.quang.stock.StockPriceResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetStockPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.quang.stock.StockPriceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.quang.stock.StockPriceResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.quang.stock.PriceUpdate> getGetPriceUpdatesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPriceUpdates",
      requestType = com.google.protobuf.Empty.class,
      responseType = com.quang.stock.PriceUpdate.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      com.quang.stock.PriceUpdate> getGetPriceUpdatesMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, com.quang.stock.PriceUpdate> getGetPriceUpdatesMethod;
      ...
      synchronized (StockServiceGrpc.class) {
        if ((getGetPriceUpdatesMethod = StockServiceGrpc.getGetPriceUpdatesMethod) == null) {
          StockServiceGrpc.getGetPriceUpdatesMethod = getGetPriceUpdatesMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, com.quang.stock.PriceUpdate>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.quang.stock.PriceUpdate.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getStockPrice(com.quang.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.quang.stock.StockPriceResponse> responseObserver) {
    ...
    default void getPriceUpdates(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<com.quang.stock.PriceUpdate> responseObserver) {
  ...
  public static final class StockServiceStub
     ...
     * </pre>
     */
    public void getStockPrice(com.quang.stock.StockPriceRequest request,
        io.grpc.stub.StreamObserver<com.quang.stock.StockPriceResponse> responseObserver) {
  ...
  public static final class StockServiceBlockingStub
     ...
     * </pre>
     */
    public com.quang.stock.StockPriceResponse getStockPrice(com.quang.stock.StockPriceRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.quang.stock.PriceUpdate> getPriceUpdates(
  ...
  public static final class StockServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.quang.stock.StockPriceResponse> getStockPrice(
        com.quang.stock.StockPriceRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_STOCK_PRICE:
          serviceImpl.getStockPrice((com.quang.stock.StockPriceRequest) request,
              (io.grpc.stub.StreamObserver<com.quang.stock.StockPriceResponse>) responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.quang.stock.StockPriceRequest,
              com.quang.stock.StockPriceResponse>(
  ...
  private static abstract class StockServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.quang.stock.StockServiceOuterClass.getDescriptor();
    }
