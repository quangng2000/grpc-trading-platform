...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.quang.user.UserServiceOuterClass.internal_static_user_StockTradeResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.quang.user.UserServiceOuterClass.internal_static_user_StockTradeResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.quang.user.StockTradeResponse.class, com.quang.user.StockTradeResponse.Builder.class);
  }
   ...
   * @return The action.
   */
  @java.lang.Override public com.quang.user.TradeAction getAction() {
    com.quang.user.TradeAction result = com.quang.user.TradeAction.forNumber(action_);
    return result == null ? com.quang.user.TradeAction.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (action_ != com.quang.user.TradeAction.BUY.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.quang.user.StockTradeResponse)) {
      return super.equals(obj);
    }
    com.quang.user.StockTradeResponse other = (com.quang.user.StockTradeResponse) obj;
  ...
  public static com.quang.user.StockTradeResponse parseFrom(
  ...
  public static com.quang.user.StockTradeResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.quang.user.StockTradeResponse parseFrom(
  ...
  public static com.quang.user.StockTradeResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.quang.user.StockTradeResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.quang.user.StockTradeResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.quang.user.StockTradeResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.quang.user.StockTradeResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.quang.user.UserServiceOuterClass.internal_static_user_StockTradeResponse_descriptor;
    }
    ...
    // Construct using com.quang.user.StockTradeResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.quang.user.StockTradeResponse getDefaultInstanceForType() {
      return com.quang.user.StockTradeResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.quang.user.StockTradeResponse build() {
      com.quang.user.StockTradeResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.quang.user.StockTradeResponse buildPartial() {
      com.quang.user.StockTradeResponse result = new com.quang.user.StockTradeResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(com.quang.user.StockTradeResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.quang.user.StockTradeResponse) {
        return mergeFrom((com.quang.user.StockTradeResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.quang.user.StockTradeResponse other) {
      if (other == com.quang.user.StockTradeResponse.getDefaultInstance()) return this;
     ...
     */
    @java.lang.Override
    public com.quang.user.TradeAction getAction() {
      com.quang.user.TradeAction result = com.quang.user.TradeAction.forNumber(action_);
      return result == null ? com.quang.user.TradeAction.UNRECOGNIZED : result;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setAction(com.quang.user.TradeAction value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000010;
  ...
  private static final com.quang.user.StockTradeResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.quang.user.StockTradeResponse();
  }

  public static com.quang.user.StockTradeResponse getDefaultInstance() {
